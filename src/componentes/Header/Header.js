  ...
  return (
    <div className="header-laranja">
      ...
      <div class='video-fapa'>
        <iframe width="808" height="480" src="https://www.youtube.com/embed/wFvku4Dyp9g" frameborder="0" autoplay="1" controls="0" ></iframe>
        <a href='https://www.youtube.com/embed/wFvku4Dyp9g' className='assista-o-video-comp'>Assistir vídeo completo<img className= 'img' src={play} alt="Play icon"/></a>
      </div>
    </div>
  );
}
